package acc.healthapp.calendar;
...
public class CalendarActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        credential = GoogleAccountCredential.usingOAuth2(
                ...
                .setSelectedAccountName(mPreferences.getString(PREF_ACCOUNT_NAME, null));

        mService = new com.google.api.services.calendar.Calendar.Builder(
                transport, jsonFactory, credential)
                .setApplicationName("NurseApp")
                .build();
    }
    ...
    private void refreshResults() {
        if (credential.getSelectedAccountName() == null) {
            ...
            if (isDeviceOnline()) {
                new ApiAsyncTask(this, mPreferences.getString(PREF_ACCOUNT_NAME, null)).execute();
            } else {
    ...
    private void authorize() throws Exception {
        ...
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(jsonFactory,
                new InputStreamReader(CalendarActivity.class.getResourceAsStream("/client_secrets.json")));
